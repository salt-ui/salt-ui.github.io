...
.hairline.dpr2 .t-button-minor {
  border: 0.5px solid #0e8ced;
}
.hairline.dpr3 .t-button-minor {
  border: 0.013333333333333rem solid #0e8ced;
}
...
.t-checkbox-field-icon.noChecked.disable {
  background-color: #ccc;
}
...
.brick .t-tab-head-item {
  ...
  padding: 0;
  padding-top: 5px;
  border-top: 1px solid #2599f2;
  border-bottom: 1px solid #2599f2;
  border-left: 1px solid #9dcef2;
  border-right: none;
}
.brick .t-tab-head-item:first-child {
  border-top-left-radius: 4px;
  border-bottom-left-radius: 4px;
  border-left: 1px solid #2599f2;
}
.brick .t-tab-head-item:last-child {
  border-top-right-radius: 4px;
  border-bottom-right-radius: 4px;
  border-right: 1px solid #2599f2;
}
...
.t-textarea-field-content {
  position: relative /*重要，解决UC、猎豹等浏览器z-index失效的问题*/;
  padding: 0 18px 0 0;
  border: none;
  outline: none;
  width: 100%;
