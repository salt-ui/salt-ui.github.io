...
class SelectLayer extends React.Component {
    ...
    render() {
        const t = this;
        const { className, maskCloseable, cancelText, confirmText } = t.props;
            ...
            >
                ...
                >
                    ...
                    <div className={prefixClass('select-layer-body FBH FC9 PR')}>
                        <Scroller  ref={`scroller`} key={`scroller`} click={true} className={prefixClass('FB1')} autoRefresh={true} tap="iscroll:tap" >
