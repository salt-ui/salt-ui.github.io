# tingle-slot [![tnpm version](http://web.npm.alibaba-inc.com/badge/v/@ali/tingle-slot.svg?style=flat-square)](http://web.npm.alibaba-inc.com/package/@ali/tingle-slot)
...
```bash
tnpm install @ali/tingle-slot --save
```
...
- [Issues](http://gitlab.alibaba-inc.com/tingle-ui/tingle-slot/issues)
