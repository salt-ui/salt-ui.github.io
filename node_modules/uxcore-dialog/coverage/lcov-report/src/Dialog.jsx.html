  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>42/73</span>
      </div>
      <div class='fl pad1y space-right2'>
...
var isSafari = false;
<span class="missing-if-branch" title="else path not taken" >E</span>if ((typeof document === 'undefined' ? <span class="branch-0 cbranch-no" title="branch not covered" >'undefined' </span>: _typeof(document)) === 'object') {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (navigator &amp;&amp; /Safari/.test(navigator.userAgent) &amp;&amp; /Apple Computer/.test(navigator.vendor)) {
    isSafari = true;
  }
}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (htmlClassName) {
...
&nbsp;
  Dialog.prototype.saveRef = <span class="fstat-no" title="function not covered" >function saveRef(refName) {</span>
...
<span class="cstat-no" title="statement not covered" >      me[refName] = c;</span>
    };
  };
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (isSafari) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jan 23 2017 14:21:27 GMT+0800 (CST)
</div>
</div>
